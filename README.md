...
- Battle Character・スキル・Q/A/Bは通常/差分とも未入力行を自動省略
...
Battle Character 第1～第3段階、スキル使用1～3、Buster / Arts / Quick 1～3は、通常モーションでも差分モーションでも未入力行を生成しません。

たとえば通常ブロックでBattle Characterの第1・第2段階だけ入力した場合、第3段階行は生成されません。
...
Battle Characterが3段階とも未入力の場合は、`Battle Character` 見出し自体も生成しません。
...
差分全体が完全に空の場合、その差分ブロック自体を生成しません。
...
- v1.4 — 通常モーションでも未入力のBattle Character行を省略し、3段階すべて未入力の場合は見出しも省略
